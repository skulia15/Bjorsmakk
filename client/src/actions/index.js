...
export const fetchPreviousRating = ({beerId, eventId, ratedById}) => async (dispatch) => {

  console.log('fetchPreviousRating');

  const res = await axios.get(`/api/ratings/${beerId}/previousRating`, { params: { eventId, ratedById } });
